...
def show_help() -> None:
    ...
    rows = [
        ...
        ("/undo", "undo last file-edit transaction"),
        ("/redo", "redo last undone transaction"),
        ("/compact", "compact/summarize session (compat mode)"),
        ("/details", "toggle tool detail visibility"),
        ("/thinking", "toggle thinking visibility"),
        ("/themes", "list available themes"),
        ("/editor", "open external editor draft"),
        ("/export", "export current session shell markdown"),
        ("/share, /unshare", "toggle local share marker"),
        ("/sessions", "list saved sessions"),
        ("/resume, /continue", "aliases for /sessions"),
        ("/session <id|#>", "switch session"),
        ("/rename <name>", "rename current session"),
        ("/delete <id|#>", "delete a session"),
        ("/agents", "list custom .mirage agents"),
        ("/thread [id]", "show or switch raw thread id"),
        ("/model [name]", "model & API configuration form"),
        ("/mode <build|plan>", "switch runtime mode permissions"),
        ...
        ("/mcp add ...", "add MCP server (--name with --command or --url)"),
        ("/mcp delete <name>", "delete configured MCP server"),
        ("/mcp disable <name>", "disable an MCP server"),
        ("/models [provider]", "list curated model ids"),
        ("/exit, /quit, /q", "RTB · exit the CLI"),
        ("", ""),
